...
struct Dance {
    ...
    uint32_t color;   // パネルの色（RGB888）。これが子どもにとっての識別子
    DanceIcon icon;   // 画面に大きく描く絵
};

static const Dance DANCES[] = {
    {"simple_nod",        0x22C55E, ICON_NOD},   // 緑
    {"side_to_side_sway", 0x3B82F6, ICON_SWAY},  // 青
    {"dizzy_spin",        0xF59E0B, ICON_SPIN},  // 黄
    {"chicken_peck",      0xEF4444, ICON_PECK},  // 赤
};
